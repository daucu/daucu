...
export default function Page(id) {
  ...
  useEffect(() => {
    if (!currentTab) {
      router.push(
        `/console/postgresql/${label}?tab=information`,
        undefined,
        {
          shallow: true,
        }
        ...
        <blockquote className="bg-white border-l-[5px] border-blue-600 dark:border-gray-500 dark:bg-gray-900 relative h-full">
          <div className="h-full relative dark:bg-slate-900 p-2 flex flex-col justify-between">
            ...
            <h2 className="text text-md dark:text-gray-400 text-black truncate">
              All the information about your account is listed below
            </h2>
            ...
            <div className="h-full mt-5 flex">
              ...
              <div className="row-span-9 col-span-10 dark:bg-slate-800 border-t-[5px] border-blue-600 dark:border-gray-500 mr-2 min-w-[300px] bg-slate-200">
                <ul className="menu rounded-sm dark:text-gray-400 text-black h-full">
                  ...
                  <button
                    ...
                    onClick={() => {
                      router.push(
                        `/console/postgresql/${label}?tab=databases`
                      );
                    }}
                  >
                    <svg
                  ...
                  <button
                    ...
                    onClick={() => {
                      router.push(`/console/postgresql/${label}?tab=backup`);
                    }}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <button
                    ...
                    onClick={() => {
                      router.push(
                        `/console/postgresql/${label}?tab=networking`
                      );
                    }}
                  >
                    <svg
                  ...
                  <button
                    ...
                    onClick={() => {
                      router.push(
                        `/console/postgresql/${label}?tab=storage`
                      );
                    }}
                  >
                    <svg
                  ...
                  <button
                    ...
                    onClick={() => {
                      router.push(`/console/postgresql/${label}?tab=logs`);
                    }}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <button
                    ...
                    onClick={() => {
                      router.push(
                        `/console/postgresql/${label}?tab=terminal`
                      );
                    }}
                  >
                    <svg
                  ...
                  <button
                    ...
                    onClick={() => {
                      router.push(
                        `/console/postgresql/${label}?tab=metrics`
                      );
                    }}
                  >
                    <svg
                  ...
                  <button
                    ...
                    onClick={() => {
                      router.push(
                        `/console/postgresql/${label}?tab=replication`
                      );
                    }}
                  >
                    <svg
                  ...
                  <button
                    ...
                    onClick={() => {
                      router.push(
                        `/console/postgresql/${label}?tab=settings`
                      );
                    }}
                  >
                    <svg
              ...
              {/* Information Area */}
              <div className="dark:bg-slate-800 bg-slate-200 border-blue-600 w-full h-full p-5 rounded-sm border-t-[5px] dark:border-gray-500 col-span-4">
                {content}
              </div>
            </div>
          </div>
