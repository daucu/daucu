          ...
          <div className="h-auto dark:bg-slate-900 p-3">
            ...
            <div className="flex flex-col justify-between items-start h-[50px]">
              ...
              <span className="text dark:text-gray-400 text-black text-xs">
                A Managed PostgreSQL Database service delivers convenient,
                cloud-based PostgreSQL hosting and administration. It manages
                infrastructure deployment, automated backups, high availability,
                robust security, and effortless scaling, allowing businesses to
                direct their attention towards application development and data
                utilization, rather than the intricacies of PostgreSQL database
                management.
              </span>
            </div>
            <div>
              <button
                className="btn btn-sm mt-5 rounded-none no-animation dark:btn-info capitalize"
                onClick={() => {
                  setShowModal(true);
                }}
              >
