          ...
          <div className="h-auto dark:bg-slate-900 p-3">
            ...
            <div className="flex flex-col justify-between items-start h-[50px]">
              <h1 className="text-xl font-bold dark:text-gray-400 text-black">
                Redis Database Clusters
              </h1>
              <span className="text dark:text-gray-400 text-black text-xs">
                A Managed Redis Database service provides seamless, cloud-based
                Redis hosting and management. It takes care of infrastructure
                setup, backups, ensuring high availability, security, and
                scaling, enabling businesses to concentrate on their
                applications and data rather than the complexities of Redis
